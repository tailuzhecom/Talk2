...
#include "../ThreadTest/logindialog.h"
...
QT_MOC_LITERAL(1, 12, 16), // "sendLoginMessage"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 8), // "userName"
QT_MOC_LITERAL(4, 39, 6), // "passwd"
QT_MOC_LITERAL(5, 46, 21) // "on_pushButton_clicked"

    },
    "LoginDialog\0sendLoginMessage\0\0userName\0"
    "passwd\0on_pushButton_clicked"
};
...
void LoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendLoginMessage((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoginDialog::sendLoginMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginDialog::sendLoginMessage(QString _t1, QString _t2)
{
