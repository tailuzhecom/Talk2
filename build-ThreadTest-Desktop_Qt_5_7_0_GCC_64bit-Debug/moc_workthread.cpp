...
#include "../ThreadTest/workthread.h"
...
void WorkThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkThread::sendMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WorkThread::sendMessage(QString _t1)
{
